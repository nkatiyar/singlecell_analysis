...
scoring_plot <- function(mydata_new, module_type, module_filename){
	...
	my_levels_celltype <- c("Tcells_naive", "Tcells_mem", "Bcells", "Dendritic/Macrophages", "Luminal-AV", "Luminal-HS", "Myoepithelial", "Fibroblasts", "Vascular", "Pericytes", "Plasma")
	...
	pdf(filename1, width=20, height=10)
	...
	pdf(filename1_n, width=20, height=10)
	...
	pdf(filename1_new, width=20, height=10)
	...
	pdf(filename2, width=20, height=10)
...
mydata_new = readRDS(args[1]) # load in your seurat dataset
