...
################################3
dir.create("results_rmv_M18_rep6")
dir.create("DESeq2_rmv_M18_rep6")
dir.create("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6")
...
get_dds_resultsAvsB_new <- function(x, A, B){
	 ...
	 # Plot PCA
        ...
        ggsave(paste0("./results_rmv_M18_rep6/", clusters[x], "_specific_PCAplot.png"))
	...
	#plot_new_batch <- pca_batch_4color + geom_label(size = 2, aes(label = group))
        plot_new_batch <- pca_batch_4color + scale_colour_manual(values=c("violet","red","royalblue1","steelblue1"))
	clusters[x] = gsub("/","_or_", clusters[x])
        #ggsave(paste0(clusters[x], "_specific_PCAplot.png"))
        ggsave(filename = paste0("./results_rmv_M18_rep6/", clusters[x], "_specific_PCAplot_batch.png"), plot = plot_new_batch, width=10, height=10)
        ...
        clusters[x] = gsub("/","_or_", clusters[x])
        #ggsave(paste0(clusters[x], "_specific_PCAplot.png"))
        ggsave(paste0("./results_rmv_M18_rep6/", clusters[x], "_specific_PCAplot_correct.png"), width=10, height=10)
	...
	plot_new_correct <- pca_4color + scale_colour_manual(values=c("violet","magenta","royalblue1","mediumpurple1"))
        clusters[x] = gsub("/","_or_", clusters[x])
        #ggsave(paste0(clusters[x], "_specific_PCAplot.png"))
        ggsave(filename = paste0("./results_rmv_M18_rep6/", clusters[x], "_specific_PCAplot_correct_4colors.png"), plot = plot_new_correct, width=10, height=10)
        ...
        png(paste0("./results_rmv_M18_rep6/", clusters[x], "_specific_heatmap.png"))
        ...
        png(paste0("results_rmv_M18_rep6/", clusters[x], "_dispersion_plot.png"))
        plotDispEsts(dds)
        dev.off()
	...
	log2FoldChange_strict_cutoff <- 1.0
        ...
        write.csv(res_tbl,
                  ...
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_all_genes.csv"),
                  quote = FALSE, 
                  row.names = FALSE)
        ...
        write.csv(sig_res_small,
                  ...
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes_FDR0.1.csv"),
                  quote = FALSE, 
                  row.names = FALSE)
        ...
        write.csv(sig_res,
                  #paste0(clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes.csv"),
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes.csv"),
                  quote = FALSE, 
                  row.names = FALSE)
	...
	# Subset the significant results
        ...
        write.csv(sig_res_upreg,
                  #paste0(clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes.csv"),
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes_upreg.csv"),
                  quote = FALSE, 
                  row.names = FALSE)
        ...
        write.csv(sig_res_downreg,
                  #paste0(clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes.csv"),
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes_downreg.csv"),
                  quote = FALSE, 
                  row.names = FALSE)
 ...
 #               dplyr::arrange(padj)
	...
	# Write significant results to file
        write.csv(sig_res_fc,
                  #paste0(clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes.csv"),
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_fc_fdr_genes.csv"), quote = FALSE, row.names = FALSE)
	...
	# Write significant results to file
        write.csv(sig_res_strict_fc,
                  #paste0(clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_genes.csv"),
                  paste0("DESeq2_rmv_M18_rep6/pairwise_rmv_M18_rep6/", clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_sig_fc_fdr_strict_genes.csv"), quote = FALSE, row.names = FALSE)
	...
	filename_heatmap_row <- paste0("../Heatmaps_rmv_M18_rep6/Heatmap_", clusters[x], "_pseudobulk_DE_genes_cluster_rows.pdf")
	...
	filename_heatmap_column <- paste0("../Heatmaps_rmv_M18_rep6/Heatmap_", clusters[x], "_pseudobulk_DE_genes_cluster_cols.pdf")
	...
	filename_heatmap_rows_column <- paste0("../Heatmaps_rmv_M18_rep6/Heatmap_", clusters[x], "_pseudobulk_DE_genes_cluster_rows_and_cols.pdf")
	pdf(filename_heatmap_rows_column, height=30)
        ...
        ggsave(paste0("./results_rmv_M18_rep6/",clusters[x], "_", levels(cluster_metadata$group_id)[A], "_vs_", levels(cluster_metadata$group_id)[B], "_top20_DE_genes.png"))
